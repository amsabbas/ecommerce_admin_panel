...
import 'package:ecommerce_admin/presentation/categories/model/form_data.dart';
...
class _CategoryDetailScreenState extends State<CategoryDetailScreen> {
  ...
  final _formData = CategoryFormData();
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Align(
          ...
          child: Container(
            constraints:
                const BoxConstraints(maxWidth: 650.0, minHeight: 450.0),
            child: Padding(
        ...
        children: [
          Padding(
            ...
            child: FormBuilderTextField(
              ...
              initialValue: _formData.categoryName,
              validator: FormBuilderValidators.required(),
              onSaved: (value) => (_formData.categoryName = value ?? ''),
            ),
          ),
          Padding(
            padding:
            ...
            child: Row(
              children: [
                ActionButtonWidget(
                    isVisible: true,
                    title: MessageKeys.backButtonTitle.tr,
                          ...
                          onPressed: () {
                            if (_formKey.currentState?.validate() ?? false) {
                              ...
                              _categoriesController
                                  .addCategory(_formData.categoryName);
                            }
                          }),
                    ],
                  ),
